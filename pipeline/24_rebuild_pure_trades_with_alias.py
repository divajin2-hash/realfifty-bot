...
fixes = {
    ...
    "주공(구현대)": ["구현대", "주공9단지", "주공11단지", "주공12단지", "압구정현대"],
    "주공(1~7단지)": ["주공1단지", "주공2단지", "주공3단지", "주공4단지", "주공5단지", "주공8단지", "주공10단지", "주공13단지", "주공14단지", "주공7단지", "주공6단지"],
...
def run_rebuild():
    ...
    print("Rebuilding PURE trades (No direct trades) WITH ALIAS MATCHING...")
