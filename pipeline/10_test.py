...
def run_master():
    ...
    output_filename = f"test_raw_{today_str}.json"
    ...
    with sync_playwright() as p:
        ...
        for c_meta in complexes_data:
            if '신현대' not in c_meta['name']: continue
            ...
            def process_ptp(p_type, retry_count=0):
                ...
                target_url = f"https://new.land.naver.com/complexes/{nid}?a=APT:JGC&b=A1&ptpNo={ptp_no}"
