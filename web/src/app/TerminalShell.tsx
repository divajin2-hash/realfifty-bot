...
export function Methodology() { return <details className="rt-panel rt-method"><summary>지표 산식과 표본 기준</summary><p>단지별 대표 타입은 유효한 호가·실거래가 있는 타입을 우선하고, 1년 이내 거래와 전용 84㎡ 근접도를 순서대로 적용합니다. 평균은 거래가 365일 이내인 비교 가능 단지의 단순 평균이며 결측값은 제외합니다.</p><p>호가 괴리 = (현재 최저호가 ÷ 최근 실거래가 − 1) × 100. 고점 대비 = (가격 ÷ 해당 타입 관측 최고 실거래가 − 1) × 100. 최근 거래와 현재 매물의 층·향·상태가 달라질 수 있습니다. 월 거래량은 현재 평형 매칭에 연결되고 고점 가격이 있는 거래를 중복 제거한 집계입니다. 회복률은 거래별 고점 대비 가격 비율의 월 중앙값입니다. 따라서 전체 계약 건수와 다를 수 있습니다. 진행 중인 월은 신고 지연과 미완결 기간의 영향을 받습니다.</p></details>; }
