...
export default async function Today() {
 ...
 <DailyChanges stamp={d.updatedAt}/>
 <AiMarketTalk/>
 <div className="rt-grid two"><section className="rt-panel"><div className="rf-eyebrow">01 / COMPLEX</div><h2>가격의 맥락까지</h2><p>타입별 실거래·매물·고점과 거래 공백을 한 화면에서 비교합니다.</p><Link className="rt-download" href="/complex">단지 탐색 →</Link></section><section className="rt-panel"><div className="rf-eyebrow">02 / RESEARCH</div><h2>근거가 남는 리포트</h2><p>핵심 관측, 관심 단지, 해석과 시나리오를 구분하는 리서치 브리핑입니다.</p><Link className="rt-download" href="/report">보고서 열기 →</Link></section></div><Methodology />
 </TerminalShell>;
}
